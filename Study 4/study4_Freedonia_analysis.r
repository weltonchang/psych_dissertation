...
t_test.original.clarity.avereldiff <- t.test(original.HC$avereldiff,original.LC$avereldiff)
t_test.original.clarity.avereldiff
# Welch Two Sample t-test
# 
# data:  original.HC$avereldiff and original.LC$avereldiff
# t = 17.135, df = 178.38, p-value < 0.00000000000000022
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   10.09885 12.72771
# sample estimates:
#   mean of x  mean of y 
# 11.4430894  0.0298103 
...
# t = 1.5339, df = 222.98, p-value = 0.1265
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   -0.2518441  2.0207532
# sample estimates:
...
# t = 0.83511, df = 226.11, p-value = 0.4045
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   -1.730418  4.275954
# sample estimates:
...
# t = -1.3133, df = 235.82, p-value = 0.1904
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
#   -3.2849169  0.6570786
# sample estimates:
...
# Df Sum Sq Mean Sq F value              Pr(>F)    
# original$clarity   1   8011    8011 294.452 <0.0000000000000002 ***
#   original$account   1     46      46   1.708               0.192    
# Residuals        243   6611      27                                
# ---
...
original.avereldiff.anova.with_interaction <- aov(original$avereldiff ~ original$clarity + original$account + original$clarity * original$account)
summary(original.absreldiff.anova.with_interaction)
# Df Sum Sq Mean Sq F value              Pr(>F)    
# original$clarity                    1   8011    8011 293.402 <0.0000000000000002 ***
#   original$account                    1     46      46   1.702               0.193    
# original$clarity:original$account   1      4       4   0.133               0.716    
# Residuals                         242   6608      27                                
# ---
#   Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
